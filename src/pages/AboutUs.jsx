...
function AboutUs() {
    ...
    return (
        <>
            ...
            {/* WHO WE ARE Section */}
            <section className="bg-[#CFE6EF] text-[#1A1A1A] pt-16 pb-16">
                <div className="max-w-4xl mx-auto px-6 md:px-10 text-center">
                    <h2 className="text-4xl md:text-5xl font-bold mb-6">Who We Are</h2>
                    <p className="text-lg md:text-xl leading-relaxed">
                        Fund Homecare Canada is a Canadian registered charitable, non-for-profit organization dedicated to making in-home care accessible to palliative cancer patients—a critical and prevalent need that is unfortunately out of reach for many.
                        <br /><br />
            ...
            {/* OUR GOALS Section */}
            <section className="bg-[#54749D] text-white pt-16 pb-16">
                <div className="max-w-4xl mx-auto px-6 md:px-10">
                    <h2 className="text-4xl md:text-5xl font-bold mb-12 text-center">Our Goals</h2>
                    ...
                    <div className="space-y-10">
                        ...
                        {/* Goal 2 */}
                        <div className="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-4">
                            <img src={visibilityIcon} alt="360 visibility icon" className="w-14 h-14" />
                            <p className="text-lg md:text-xl leading-relaxed">
                        ...
                        {/* Goal 3 */}
                        <div className="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-4">
                            <img src={fundingIcon} alt="funding icon" className="w-14 h-14" />
                            <p className="text-lg md:text-xl leading-relaxed">
                        ...
                        {/* Goal 4 */}
                        <div className="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-4">
                            <img src={communicationIcon} alt="communication icon" className="w-14 h-14" />
                            <p className="text-lg md:text-xl leading-relaxed">
            ...
            <div className="bg-[#307694] py-12 md:py-20 w-full">
                <div className="w-full px-4 sm:px-6 mx-auto">
                    <h2 className="text-white font-bold text-3xl sm:text-4xl md:text-5xl mb-8 md:mb-12 text-center" style={{ fontFamily: 'Montserrat' }}>
                        Meet Our Team
                    </h2>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 md:gap-8 w-full">
                        ...
                        <OurTeamCard
                            ...
                            Denise is a licensed Paralegal and has worked in the non-for-profit industry for over 15 years. She has vast experience in dealing with government organizations, the healthcare industry, and community agencies."
                        />
