          ...
          <div className="flex">
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 w-80 rounded-l-md border border-gray-300 text-black text-sm focus:outline-none"
              />
            </div>
            <button className="bg-[#c1c7cd] hover:bg-blue-700 active:bg-gray-500 text-white px-4 py-2 rounded-r-md text-sm">
              Subscribe
            </button>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-6 border-t border-gray-400 pt-6">
          ...
          <div className="md:w-1/3 flex flex-col items-center justify-center">
            ...
            <p className="text-xs text-center">
              Developed and Built by Tech for Social Impact®
            </p>
          </div>
        </div>
