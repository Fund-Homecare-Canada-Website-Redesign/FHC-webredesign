        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 border-t border-gray-400 pt-6 text-left">
          <div>
            ...
            <div className="mt-2 space-y-2 text-left text-sm">
              <Link to="/" className="text-white no-underline hover:underline block">Home</Link>
              <Link to="/about-us" className="text-white no-underline hover:underline block">About Us</Link>
              <Link to="/events" className="text-white no-underline hover:underline block">Events</Link>
              <Link to="/beneficiaries" className="text-white no-underline hover:underline block">Beneficiaries</Link>
              <Link to="/contact-us" className="text-white no-underline hover:underline block">Contact Us</Link>
            </div>
          </div>
