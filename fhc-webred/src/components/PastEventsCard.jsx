...
import image1 from "./logo192.png"; // Import the image
...
function PastEventsCard() {
  ...
  return (
    <div
      className="relative flex flex-row items-start border shadow-md p-5 m-2 text-left max-w-[66%] inline-block rounded-lg transition-all duration-300"
      style={{ backgroundColor: "#3A92A0" }} // Set background color to #3A92A0
    >
      <div className="flex-1">
        <h2
          className="text-lg font-bold mb-1"
          style={{ color: "#FFFFFF" }} // Set text color to white for contrast
        >
          Event Name
        </h2>
        <h3
        ...
        <div className="rounded-e-2xl mt-2">
          <button
            className="flex flex-row items-center text-white outline-none px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors"
            style={{
      ...
      <img
        src={image1}
        alt="Event Logo"
        className="w-24 h-24 border ml-3"
      />
    </div>
  );
}
